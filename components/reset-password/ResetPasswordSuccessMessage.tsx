...
export default function ResetPasswordSuccessMessage(props: SuccessMessageProps) {
  return (
    <>
    {props.showSuccessMessage ? 
        <div className="absolute top-0 left-0 w-full h-full bg-white p-6 pt-0 flex flex-row justify-center items-center">
