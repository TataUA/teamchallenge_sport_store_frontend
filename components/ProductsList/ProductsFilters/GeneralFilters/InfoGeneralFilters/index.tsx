    ...
    <>
      <div className="flex justify-between items-center mb-4 text-sm font-medium text-[#272728] min-[2800px]:mb-8">
        {props.products?.length ? (
          ...
          <h3 className="text-lg font-semibold mb-2 text-[#DF0707] min-[2800px]:text-3xl">
            Нічого не знайдено
          </h3>
        )}
        <button
      ...
      <div className="flex justify-center items-center">
        <button
          ...
          className={cn(
            "m-auto w-full py-3 bg-blue text-white font-base font-medium rounded-xl hover:opacity-75",
            "min-[2800px]:text-3xl",
            {
