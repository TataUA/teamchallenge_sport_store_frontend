...
const DeliverSection = ({
  ...
  const labelCheckboxClassname = "flex gap-2 mb-2 md:mb-2 items-center";
      ...
      <div className={cn("mb-4", { "opacity-[50%]": !city })}>
        <label className={labelCheckboxClassname}>
          ...
          <svg
            className="
              absolute 
              w-4 h-4 ml-[2px] md:w-5 md:h-5 md:ml-0
        ...
        {deliveryType === "Branch" && city ? (
          <CustomDepartmentsDropdown
            handleChangeOrder={handleChangeOrder}
            city={city}
            typeOfEntity="department"
          />
        ) : null}
      </div>
      <div className={cn("mb-4", { "opacity-[50%]": !city })}>
        <label className={labelCheckboxClassname}>
          <input
            ...
            onChange={() =>
              handleOnChangeDelivery("deliveryType", "Parcel Locker")
            }
          />
          <svg
            className="
        ...
        {deliveryType === "Parcel Locker" && city ? (
          <CustomDepartmentsDropdown
            handleChangeOrder={handleChangeOrder}
            city={city}
            typeOfEntity="postOffice"
          />
        ) : null}
      </div>
